...
public class Program
{
    ...
    {
        /// Takes a path for a spritesheet
        ...
        /// Takes a plist file
        /// NB: Only known to work with plist files generated by the Pack function
        ...
        /// Takes a destination directory path
        ...
        foreach (NSDictionary dict in array)
        {
            ...
            /// reates a new image to be drawn, sourcing from a section of the spritesheet
